...
{
    [DbContext(typeof(DropShoppingDbContext))]
    [Migration("20250910123449_FullIntialCreate")]
    partial class FullIntialCreate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Customer", b =>
                {
                    ...
                    b.Property<string>("DropshipperId")
                        .IsRequired()
            ...
            modelBuilder.Entity("DAL.Models.OrderItem", b =>
                {
                    ...
                    b.Property<decimal>("OrderItemDiscount")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("DAL.Models.Customer", b =>
                {
                    b.HasOne("DAL.Models.User", "Dropshipper")
                        .WithMany()
                        .HasForeignKey("DropshipperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Dropshipper");
                });
            ...
            modelBuilder.Entity("DAL.Models.Dropshipper", b =>
                {
                    b.HasOne("DAL.Models.User", "User")
                        .WithOne("Dropshipper")
                        .HasForeignKey("DAL.Models.Dropshipper", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.Models.Wallet", b =>
                {
                    b.HasOne("DAL.Models.Dropshipper", "Dropshipper")
                        .WithOne("Wallet")
                        .HasForeignKey("DAL.Models.Wallet", "DropshipperId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
